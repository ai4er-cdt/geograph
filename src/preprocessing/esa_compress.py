...
def eunis_to_superclasses(input_array):
    ...
    new_class_1 = np.where((input_array == 21)|(input_array == 22)|(input_array == 23)
                             |(input_array == 24)|(input_array == 29)|
                             (input_array == 30)|(input_array == 31)|
                             (input_array == 33),
                             1, input_array)
    ...
    new_class_6 = np.where((input_array == 35)|(input_array == 36)|(input_array == 37),
                             6, new_class_5)
    new_class_7 = np.where((input_array == 25)|(input_array == 26)|
                            (input_array == 27)|(input_array == 28),
                             7, new_class_6)
    ...
    new_class_12 = np.where((input_array == 9)|(input_array == 11),
                             12, new_class_11)
    new_class_13 = np.where((input_array == 16)|(input_array == 17)|
                            (input_array == 18)|(input_array == 32), 
                             13, new_class_12)
    ...
    new_class_17 = np.where((input_array == 42),
                             17, new_class_16)
    new_class_18 = np.where((input_array == 12)|(input_array == 13)|
                             (input_array == 14)|(input_array == 15)|
                            (input_array == 20),
                             18, new_class_17)
