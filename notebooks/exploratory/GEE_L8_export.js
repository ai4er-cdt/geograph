...
var temporalFiltered_winter = spatialFiltered.filterDate('2014-10-01', '2015-03-31');
...
var dataset_winter = temporalFiltered_winter.map(maskL8sr);
...
var image_JFM = dataset_JFM.median().select(['B1', 'B3', 'B2','B4']);
print(image_JFM);

var image_AMJ = dataset_AMJ.median().select(['B1', 'B3', 'B2','B4']);
var image_JAS = dataset_JAS.median().select(['B1', 'B3', 'B2','B4']);
var image_OND = dataset_OND.median().select(['B1', 'B3', 'B2','B4']);
